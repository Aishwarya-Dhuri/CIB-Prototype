...
export class UBDataLayoutComponent implements OnInit {
  ...
  colDefUrl = 'payments/masters/beneficiaryUpload/private/dataMappingDetailsColDefs';
  dataMapping = [
    {
      header: [
        {
  ...
  getGridData() {
    const url = 'payments/masters/beneficiaryUpload/private/dataMappingDetailsData';

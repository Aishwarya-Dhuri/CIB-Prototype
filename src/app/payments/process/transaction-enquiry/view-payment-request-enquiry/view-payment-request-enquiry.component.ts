...
@Component({
  selector: 'app-view-payment-request-enquiry',
  templateUrl: './view-payment-request-enquiry.component.html',
  styleUrls: ['./view-payment-request-enquiry.component.scss'],
})
export class ViewPaymentRequestEnquiryComponent implements OnInit {

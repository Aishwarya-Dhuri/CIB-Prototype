...
export class ViewBillPaymentComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.transactionDetails = [
      { label: '1.1 Bill Payment Details', data: { key: 'billPaymentDetails' } },
      { label: '1.2 Supporting Document', data: { key: 'supportingDocument' } },
      { label: '1.3 Maker Checker Details', data: { key: 'makerCheckerDetails' } },
    ];
    ...
    this.httpService
      .httpPost('payments/transactions/billPayment/private/viewBillPaymentEnquiry', data)

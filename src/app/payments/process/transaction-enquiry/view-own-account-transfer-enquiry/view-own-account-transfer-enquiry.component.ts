...
@Component({
  selector: 'app-view-own-account-transfer-enquiry',
  templateUrl: './view-own-account-transfer-enquiry.component.html',
  styleUrls: ['./view-own-account-transfer-enquiry.component.scss'],
})
export class ViewOwnAccountTransferEnquiryComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.transactionDetails = [
      ...
      { label: '1.3 Credit Account', data: { key: 'creditAccount' } },
    ...
    // const data = {"dataMap":{"id":1640790729027}};
    this.httpService

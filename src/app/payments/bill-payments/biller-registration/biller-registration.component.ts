...
import { BillerRegistration } from './@model/biller-registration.model';

@Component({
  selector: 'app-biller-registration',
  templateUrl: './biller-registration.component.html',
  styleUrls: ['./biller-registration.component.scss'],
})
export class BillerRegistrationComponent implements OnInit {
  ...
  formData: BillerRegistration = new BillerRegistration();
  ...
  ngOnInit(): void {
    const actions: Actions = {
      heading: 'Biller Registration - Initiate',
      subHeading: null,

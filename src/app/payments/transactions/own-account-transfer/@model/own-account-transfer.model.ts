export class OwnAccountTransfer {
  ...
  public paymentRequestDetails?: OwnAccountTransferDetail[];
  ...
  constructor() {
    ...
    this.paymentRequestDetails = [new OwnAccountTransferDetail()];
  }
}

export class OwnAccountTransferDetail {
  ...
  public enrichments?: Enrichments[];
  public remarks?: string;

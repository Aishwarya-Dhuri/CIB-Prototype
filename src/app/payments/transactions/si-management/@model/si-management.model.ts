export class SiManagement {
  ...
  public siStartDate?: string;
  public siEndDate?: string;
  public siManagementDetails?: SiManagementDetail[];
  ...
  constructor() {
    ...
    this.siStartDate = '';
    this.siEndDate = '';
    this.siManagementDetails = [new SiManagementDetail()];
...
export class SiManagementDetail {
  ...
  public remarks?: string;
  public siManagementAdditionalDetail?: SiManagementAdditionalDetail[];
  ...
  constructor() {
    ...
    this.enrichments = '';
    this.remarks = '';
    this.siManagementAdditionalDetail = [new SiManagementAdditionalDetail()];
  }
}

export class SiManagementAdditionalDetail {
  public beneficiaryAccountNo?: string;

...
import { AmendmentUpload } from './@model/amendment-upload.model';
...
export class AmendmentUploadComponent implements OnInit {
  loading: boolean;
  mode: string;

  formData: AmendmentUpload = new AmendmentUpload();
  ...
  stepperDetails: Stepper = {
    ...
    headings: ['Amendment Upload', 'Review Details & Confirm'],
  };
  ...
  ngOnInit(): void {
    const actions: Actions = {
      heading: 'Amendment Upload - Initiate',
      subHeading: null,
    ...
    if (this.mode == 'EDIT' || this.mode == 'VIEW') {
      ...
      this.httpService
        .httpPost('directDebit/mandateManagement/amendmentUpload/private/view', data)

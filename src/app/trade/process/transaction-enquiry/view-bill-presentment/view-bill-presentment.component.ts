...
@Component({
  selector: 'app-view-bill-presentment',
  templateUrl: './view-bill-presentment.component.html',
  styleUrls: ['./view-bill-presentment.component.scss'],
})
export class ViewBillPresentmentComponent implements OnInit {
  orgTreeData: any[];
    ...
    this.orgTreeData = [
      {
        ...
        nodes: [
          {
            isLeafNode: false,
            header: 'Bill Presentment Initiate',
...

      {
        ...
        nodes: [
          {
            isLeafNode: false,
            header: 'Bill Presentment Verified',
...

      {
        ...
        nodes: [
          {
            isLeafNode: false,
            header: 'Bill Presentment Approved',
...

      {
        ...
        nodes: [
          {
            isLeafNode: true,
            header: 'Bill Presentment Successfully Posted',
            subHeader: '',
            active: false,
            partiallyActive: false,
            disabled: true,

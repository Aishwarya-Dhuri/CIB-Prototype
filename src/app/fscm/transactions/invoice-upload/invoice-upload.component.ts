...
import { UserUpload } from 'src/app/setup/security/user-upload/@models/user-upload.model';
...
export class InvoiceUploadComponent implements OnInit {
  ...
  userUploadList = [{ id: 'invoiceUpload', displayName: 'Invoice Upload' }];
  ...
  getViewData(): void {
    ...
    if (this.mode == 'EDIT' || this.mode == 'VIEW') {
      ...
      this.httpService
        .httpPost('fscm/transactions/invoiceUpload/private/view', data)
        .subscribe((formData: InvoiceUpload) => {
  ...
  onSubmit() {
    let url = 'fscm/transactions/invoiceUpload/private/';
  ...
  cancel() {
    this.router.navigateByUrl('fscm/transactions/invoiceUpload/listing');
  }
}

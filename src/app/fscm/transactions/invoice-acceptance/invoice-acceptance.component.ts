...
@Component({
  ...
  templateUrl: './invoice-acceptance.component.html',
  styleUrls: ['./invoice-acceptance.component.scss'],
})
export class InvoiceAcceptanceComponent implements OnInit {
  @ViewChild('listing') listing: AgGridListingComponent;
  @ViewChild('transactionDetails') transactionDetails: AgGridListingComponent;
  ...
  tabs: any[] = [
    {
      ...
      colDefsUrl: 'fscm/transactions/invoiceAcceptance/private/colDefs',
      rowDefsUrl: 'fscm/transactions/invoiceAcceptance/private/getRecentInvoices',
      count: '0',
    },
    {
      label: 'Near Dues',
      colDefsUrl: 'fscm/transactions/invoiceAcceptance/private/colDefs',
      rowDefsUrl: 'fscm/transactions/invoiceAcceptance/private/getNearDueInvoices',
      count: '0',
    },
  ];
  ...
  purchaseOrderDetailColDefs = 'fscm/transactions/invoiceAcceptance/private/purchesOrderDetailsColDefs'
  purchaseOrderRowData: any[] = [];
  ...
  ngOnInit(): void {
    ...
    const actions: Actions = {
      heading: 'Invoice Acceptance - Initiate',
      subHeading: null,
  ...
  getSearchResults() {
    ...
    this.activeTab = {
      ...
      colDefsUrl: 'fscm/transactions/invoiceAcceptance/private/colDefs',
      rowDefsUrl: 'fscm/transactions/invoiceAcceptance/private/getSearchedInvoices',
      count: '0',
    };
  ...
  onAccept() {
    this.httpService
      .httpPost('fscm/transactions/invoiceAcceptance/private/acceptInvoices', {
        dataMap: {
  ...
  onReject() {
    this.httpService
      .httpPost('fscm/transactions/invoiceAcceptance/private/rejectInvoices', {
        dataMap: {
          data: this.singleDataForAction.length > 0 ? this.singleDataForAction : this.dataForAction,
          remark: this.remarkInput,
        },
  ...
  onView(id: string) {
    this.httpService
      .httpPost('fscm/transactions/invoiceAcceptance/private/getAuthorizedInvoice', {
        dataMap: { id },
      })
      .subscribe((data: any) => {
        this.viewInvoiceData = data;
        this.purchaseOrderRowData = data.poDetails;

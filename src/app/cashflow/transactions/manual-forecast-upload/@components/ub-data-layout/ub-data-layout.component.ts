...
@Component({
  selector: 'app-ub-data-layout',
  templateUrl: './ub-data-layout.component.html',
  styleUrls: ['./ub-data-layout.component.scss']
})
export class UbDataLayoutComponent implements OnInit {
  activeStep: any;
  activeStepIndex: number = 0;

  colDefUrl = 'cashflow/transactions/manualForecastUpload/private/dataMappingDetailsColDefs';
  dataMapping = [
    {
      header: [
        {
  ...
  getGridData() {
    const url = 'cashflow/transactions/manualForecastUpload/private/dataMappingDetailsData';

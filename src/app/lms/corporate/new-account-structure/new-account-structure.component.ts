...
@Component({
  selector: 'app-new-account-structure',
  templateUrl: './new-account-structure.component.html',
  styleUrls: ['./new-account-structure.component.scss']
})
export class NewAccountStructureComponent extends GenericListingComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.httpService
      .httpPost('lms/corporate/newAccountStructure/private/getStructureTypes')
  ...
  onCreateNewStructure() {
    this.newAccountStructureService.structureCreationType = this.structureCreationType.toLowerCase();
    this.createNewStructureDialog = false;

    this.router.navigate(['newInitiate'], { relativeTo: this.route });
  }
  ...
  selectStructure(structure: any) {
    ...
    // this.httpService.httpPost('lms/corporate/newAccountStructure/private/getAllCount', this.defaultReqModel).subscribe(()=>{})
  ...
  navigateToInitiate(): void {
    this.router.navigateByUrl(this.menuService.getSelectedServiceUrl() + '/newInitiate');
  }
  ...
  //   this.httpService
  //     .httpPost('lms/corporate/newAccountStructure/private/deleteDraft', data)
  //     .subscribe((res) => {
  //       this.listing.refreshGridList();
  //     });
  // };

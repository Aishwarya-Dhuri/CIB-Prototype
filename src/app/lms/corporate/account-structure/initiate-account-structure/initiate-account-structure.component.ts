...
@Component({
  selector: 'app-initiate-account-structure',
  templateUrl: './initiate-account-structure.component.html',
  styleUrls: ['./initiate-account-structure.component.scss'],
})
export class InitiateAccountStructureComponent implements OnInit {
  @ViewChild('mainAccountDetailsComponent') mainAccountDetailsComponent: any;
  @ViewChild('accountStructureHierarchyComponent') accountStructureHierarchyComponent: any;
  ...
  mainAccountDetails: AccountDetails = new AccountDetails();
  ...
  ngOnInit(): void {
    ...
    this.structureCreationType = this.accountStructureService.structureCreationType;
  ...
  selectStructure(structureId: string) {
    ...
    this.httpService
      ...
      .subscribe((formData: any) => {
        this.formData = formData;
        this.beforeRenderer();
        this.accountStructureService.structureCreationType = 'create';
  ...
  addChildAccount() {
    ...
    if (this.accountStructureHierarchyComponent) {
      this.accountStructureHierarchyComponent.refreshStructureHierarchyGrid();
    }
  }
  ...
  validateForm(stepNo: number) {
    if (stepNo == 1) {
      if (this.mainAccountDetailsComponent && this.mainAccountDetailsComponent.form) {
        this.mainAccountDetailsComponent.form.form.markAllAsTouched();
        return !this.mainAccountDetailsComponent.form.invalid;
      }
    }

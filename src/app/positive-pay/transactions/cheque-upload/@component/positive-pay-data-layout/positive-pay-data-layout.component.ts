...
@Component({
  selector: 'app-positive-pay-data-layout',
  templateUrl: './positive-pay-data-layout.component.html',
  styleUrls: ['./positive-pay-data-layout.component.scss'],
})
export class PositivePayDataLayoutComponent implements OnInit {
  activeStep: any;
